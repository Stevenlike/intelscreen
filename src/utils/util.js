 ...
 * 初始化一个简单的默认渲染器，并将其绑定到“webgl输出”dom
 * element.
 *
 ...
 */
export let applyMeshStandardMaterial = function(geometry, material) {
 ...
 *                     this material will only be used if it is a meshnormal material.
 */
export let applyMeshNormalMaterial = function(geometry, material) {
